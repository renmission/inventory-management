...
This project is an Inventory Management Dashboard built with Next.js, Node.js, PostgreSQL, and Tailwind CSS. The application is designed to help manage inventory efficiently and is deployed on AWS using EC2, RDS, and S3.
